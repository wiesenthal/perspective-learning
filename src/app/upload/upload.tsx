...
const UploadSelector = ({
  ...
  return (
    <div className="size-full fixed bg-white/50 top-0 left-0 backdrop-blur-sm">
      <div
        className="UploadSelector fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col items-center justify-center bg-black/50 p-12 rounded-full max-h-[80%] overflow-y-auto backdrop-blur"
